...
<head>
    ...
    <style>
        ...
        .profile-pic {
            width: 120px; /* Small size for profile picture */
            height: 120px;
            border-radius: 50%;
            object-fit: cover;
            margin-bottom: 20px; /* Space between profile picture and details */
        }
        .profile-details {
            font-size: 18px;
            color: #495057;
...
<body>
    <div class="profile-container">
        ...
        <c:if test="${not empty student}">
            <!-- Add a default image or handle null with ternary operator -->
        ...
        <c:if test="${empty student}">
            <p class="error-message">Student profile not found.</p>
        </c:if>
    </div>
</body>
</html>